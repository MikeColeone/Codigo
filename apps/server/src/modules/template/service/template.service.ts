...
export class TemplateService {
  ...
  private readonly defaultTemplateVersions: Record<string, number> = {
    ...
    'ai-chat-copilot-single': 2,
    'ai-dataset-generator-single': 2,
    'agent-workflow-center-single': 2,
    'marketing-copy-studio-single': 2,
    'knowledge-qa-single': 2,
    'lead-scoring-center-single': 2,
    'finance-reconciliation-single': 2,
    'iot-device-monitor-single': 2,
    'support-quality-review-single': 2,
    'recruitment-screening-single': 2,
    'content-calendar-single': 2,
    'data-analytics-overview-single': 2,
  };
